...
#if RK_FIX_POINT_REPLACE_DOUBLE_POINT
	if (qp <= 51)
		m_rows[row].m_rdCost.setLambda(lambda, qp, slice->getSliceType());
	else
...
#if RK_FIX_POINT_REPLACE_DOUBLE_POINT
		if (qp <= 51)
			m_rows[i].m_rdCost.setLambda(lambda, qp, slice->getSliceType());
		else
