...
static const struct option long_options[] =
{
	...
	{ "merangex",        required_argument, NULL, 0 },
	{ "merangey",        required_argument, NULL, 0 },
	{ "judgestand",        required_argument, NULL, 0 },
...
#define OPT(value) (value ? "enabled" : "disabled")
	...
	H0("   --merangex                    X Coordinate of Motion search range. Default %d\n", param->meRangeX);
	H0("   --merangey                    Y Coordinate of Motion search range. Default %d\n", param->meRangeY);
	H0("   --judgestand                  Judgement Standard for Inter Mode Decision. Default %s\n", "SSE");
...
bool CLIOptions::parse(int argc, char **argv, x265_param* param)
{
    ...
    const char *tune = "zero-latency";      // ssim
